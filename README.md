...
- O app serve para organizar os contatos adicionando imagens aos contatos, nome. email e telefone.
...
- O app usa shared preferences para guardar o login do usuario, caso deseje
